...
template <> class Action1<::DotNet::UnityEngine::AsyncOperation> {
  private: friend std::uint8_t (::initializeReinterop)(std::uint64_t validationHash, void** functionPointers, std::int32_t count);
  private: ::DotNet::Reinterop::ObjectHandle _handle;
  public: explicit Action1(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Action1(std::nullptr_t) noexcept;
  ...
  private: static void (*CallInvoke_GZtSECpzDV__dvLP8ujKEdA)(void* thiz, void* obj, void** reinteropException);
  public: void Invoke(const ::DotNet::UnityEngine::AsyncOperation& obj) const;
  ...
  public: bool operator==(const Action1& rhs) const;
  ...
  public: using FunctionSignature = void (const ::DotNet::UnityEngine::AsyncOperation&);
  public: Action1(std::function<FunctionSignature> callback);
  private: static void* (*CombineDelegates)(void* thiz, void* rhs);
  private: static void* (*RemoveDelegate)(void* thiz, void* rhs);
  public: ::DotNet::System::Action1<::DotNet::UnityEngine::AsyncOperation> operator+(const ::DotNet::System::Action1<::DotNet::UnityEngine::AsyncOperation>& rhs) const;
  public: ::DotNet::System::Action1<::DotNet::UnityEngine::AsyncOperation> operator-(const ::DotNet::System::Action1<::DotNet::UnityEngine::AsyncOperation>& rhs) const;
