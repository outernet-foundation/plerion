...
class Exception {
  ...
  public: explicit Exception(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Exception(std::nullptr_t) noexcept;
  ...
  public: Exception(const ::DotNet::System::String& message);
