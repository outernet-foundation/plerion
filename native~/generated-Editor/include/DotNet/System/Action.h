...
class Action {
  ...
  public: explicit Action(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Action(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const Action& rhs) const;
  ...
  public: Action(std::function<FunctionSignature> callback);
  private: static void* (*CombineDelegates)(void* thiz, void* rhs);
  private: static void* (*RemoveDelegate)(void* thiz, void* rhs);
  public: ::DotNet::System::Action operator+(const ::DotNet::System::Action& rhs) const;
  public: ::DotNet::System::Action operator-(const ::DotNet::System::Action& rhs) const;
