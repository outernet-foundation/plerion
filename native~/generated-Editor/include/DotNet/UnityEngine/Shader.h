...
class Shader {
  ...
  public: explicit Shader(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Shader(std::nullptr_t) noexcept;
  public: const ::DotNet::Reinterop::ObjectHandle& GetHandle() const;
  public: ::DotNet::Reinterop::ObjectHandle& GetHandle();
  public: operator ::DotNet::UnityEngine::Object() const;
  public: operator ::DotNet::System::Object() const;
  private: static ::std::int32_t (*CallPropertyToID_wfPSjxsETIcebv8un8PGZw)(void* name, void** reinteropException);
  public: static ::std::int32_t PropertyToID(const ::DotNet::System::String& name);
  ...
  public: bool operator==(const Shader& rhs) const;
