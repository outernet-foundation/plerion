...
class MeshRenderer {
  ...
  public: explicit MeshRenderer(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: MeshRenderer(std::nullptr_t) noexcept;
  public: const ::DotNet::Reinterop::ObjectHandle& GetHandle() const;
  public: ::DotNet::Reinterop::ObjectHandle& GetHandle();
  private: static void* (*Construct_1B2M2Y8AsgTpgAmY7PhCfg)(void** reinteropException);
  public: MeshRenderer();
  public: operator ::DotNet::UnityEngine::Renderer() const;
  public: operator ::DotNet::UnityEngine::Component() const;
  public: operator ::DotNet::UnityEngine::Object() const;
  public: operator ::DotNet::System::Object() const;
  private: static void* (*Property_get_material)(void* thiz, void** reinteropException);
  public: ::DotNet::UnityEngine::Material material() const;
  private: static void (*Property_set_material)(void* thiz, void* value, void** reinteropException);
  public: void material(const ::DotNet::UnityEngine::Material& value) const;
  private: static void* (*Property_get_sharedMaterial)(void* thiz, void** reinteropException);
  public: ::DotNet::UnityEngine::Material sharedMaterial() const;
  private: static void (*Property_set_sharedMaterial)(void* thiz, void* value, void** reinteropException);
  public: void sharedMaterial(const ::DotNet::UnityEngine::Material& value) const;
  ...
  public: bool operator==(const MeshRenderer& rhs) const;
