...
class Behaviour {
  ...
  public: explicit Behaviour(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Behaviour(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const Behaviour& rhs) const;
