...
class Component {
  ...
  public: explicit Component(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Component(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const Component& rhs) const;
