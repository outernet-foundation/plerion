...
class UnityWebRequestAsyncOperation {
  ...
  public: explicit UnityWebRequestAsyncOperation(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: UnityWebRequestAsyncOperation(std::nullptr_t) noexcept;
  public: bool operator==(std::nullptr_t) const noexcept;
  public: bool operator!=(std::nullptr_t) const noexcept;
  public: const ::DotNet::Reinterop::ObjectHandle& GetHandle() const;
  public: ::DotNet::Reinterop::ObjectHandle& GetHandle();
  public: operator ::DotNet::UnityEngine::AsyncOperation() const;
