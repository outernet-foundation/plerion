...
class Renderer {
  ...
  public: explicit Renderer(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: Renderer(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const Renderer& rhs) const;
