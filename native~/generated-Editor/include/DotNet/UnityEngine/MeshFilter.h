...
class MeshFilter {
  ...
  public: explicit MeshFilter(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: MeshFilter(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_mesh)(void* thiz, void** reinteropException);
  public: ::DotNet::UnityEngine::Mesh mesh() const;
  private: static void (*Property_set_mesh)(void* thiz, void* value, void** reinteropException);
  public: void mesh(const ::DotNet::UnityEngine::Mesh& value) const;
  ...
  public: bool operator==(const MeshFilter& rhs) const;
