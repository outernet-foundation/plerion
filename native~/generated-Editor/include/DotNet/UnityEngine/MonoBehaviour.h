...
class MonoBehaviour {
  ...
  public: explicit MonoBehaviour(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: MonoBehaviour(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const MonoBehaviour& rhs) const;
