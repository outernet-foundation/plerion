...
class ScriptableSingleton1;

template <> class ScriptableSingleton1<::DotNet::CesiumForUnity::CesiumIonServerManager> {
  private: friend std::uint8_t (::initializeReinterop)(std::uint64_t validationHash, void** functionPointers, std::int32_t count);
  private: ::DotNet::Reinterop::ObjectHandle _handle;
  public: explicit ScriptableSingleton1(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: ScriptableSingleton1(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const ScriptableSingleton1& rhs) const;
