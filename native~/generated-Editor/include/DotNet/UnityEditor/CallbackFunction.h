...
class CallbackFunction {
  ...
  public: explicit CallbackFunction(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CallbackFunction(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const CallbackFunction& rhs) const;
  ...
  public: CallbackFunction(std::function<FunctionSignature> callback);
  private: static void* (*CombineDelegates)(void* thiz, void* rhs);
  private: static void* (*RemoveDelegate)(void* thiz, void* rhs);
  public: ::DotNet::UnityEditor::CallbackFunction operator+(const ::DotNet::UnityEditor::CallbackFunction& rhs) const;
  public: ::DotNet::UnityEditor::CallbackFunction operator-(const ::DotNet::UnityEditor::CallbackFunction& rhs) const;
