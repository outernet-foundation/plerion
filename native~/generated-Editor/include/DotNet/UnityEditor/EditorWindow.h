...
class EditorWindow {
  ...
  public: explicit EditorWindow(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: EditorWindow(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const EditorWindow& rhs) const;
