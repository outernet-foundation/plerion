...
class CesiumDebugColorizeTilesRasterOverlay {
  ...
  public: explicit CesiumDebugColorizeTilesRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumDebugColorizeTilesRasterOverlay(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const CesiumDebugColorizeTilesRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumDebugColorizeTilesRasterOverlayImpl& NativeImplementation() const noexcept;
};
