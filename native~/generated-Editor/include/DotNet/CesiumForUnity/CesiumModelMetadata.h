...
class CesiumModelMetadata {
  ...
  public: explicit CesiumModelMetadata(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumModelMetadata(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_propertyTables)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Array1<::DotNet::CesiumForUnity::CesiumPropertyTable> propertyTables() const;
  private: static void (*Property_set_propertyTables)(void* thiz, void* value, void** reinteropException);
  public: void propertyTables(const ::DotNet::System::Array1<::DotNet::CesiumForUnity::CesiumPropertyTable>& value) const;
  ...
  public: bool operator==(const CesiumModelMetadata& rhs) const;
