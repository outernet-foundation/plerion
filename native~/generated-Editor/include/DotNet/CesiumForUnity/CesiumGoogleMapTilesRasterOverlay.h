...
class CesiumGoogleMapTilesRasterOverlay {
  ...
  public: explicit CesiumGoogleMapTilesRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumGoogleMapTilesRasterOverlay(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_apiKey)(void* thiz, void** reinteropException);
  public: ::DotNet::System::String apiKey() const;
  private: static void (*Property_set_apiKey)(void* thiz, void* value, void** reinteropException);
  public: void apiKey(const ::DotNet::System::String& value) const;
  private: static ::std::uint32_t (*Property_get_mapType)(void* thiz, void** reinteropException);
  public: ::DotNet::CesiumForUnity::GoogleMapTilesMapType mapType() const;
  private: static void (*Property_set_mapType)(void* thiz, ::std::uint32_t value, void** reinteropException);
  public: void mapType(::DotNet::CesiumForUnity::GoogleMapTilesMapType value) const;
  ...
  private: static void* (*Property_get_region)(void* thiz, void** reinteropException);
  public: ::DotNet::System::String region() const;
  private: static void (*Property_set_region)(void* thiz, void* value, void** reinteropException);
  public: void region(const ::DotNet::System::String& value) const;
  private: static ::std::uint32_t (*Property_get_scale)(void* thiz, void** reinteropException);
  public: ::DotNet::CesiumForUnity::GoogleMapTilesScale scale() const;
  private: static void (*Property_set_scale)(void* thiz, ::std::uint32_t value, void** reinteropException);
  public: void scale(::DotNet::CesiumForUnity::GoogleMapTilesScale value) const;
  private: static ::std::uint8_t (*Property_get_highDpi)(void* thiz, void** reinteropException);
  public: bool highDpi() const;
  private: static void (*Property_set_highDpi)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void highDpi(bool value) const;
  private: static void* (*Property_get_layerTypes)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::GoogleMapTilesLayerType> layerTypes() const;
  private: static void (*Property_set_layerTypes)(void* thiz, void* value, void** reinteropException);
  public: void layerTypes(const ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::GoogleMapTilesLayerType>& value) const;
  private: static void* (*Property_get_styles)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::System::String> styles() const;
  private: static void (*Property_set_styles)(void* thiz, void* value, void** reinteropException);
  public: void styles(const ::DotNet::System::Collections::Generic::List1<::DotNet::System::String>& value) const;
  private: static ::std::uint8_t (*Property_get_overlay)(void* thiz, void** reinteropException);
  public: bool overlay() const;
  private: static void (*Property_set_overlay)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void overlay(bool value) const;
  ...
  public: bool operator==(const CesiumGoogleMapTilesRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumGoogleMapTilesRasterOverlayImpl& NativeImplementation() const noexcept;
};
