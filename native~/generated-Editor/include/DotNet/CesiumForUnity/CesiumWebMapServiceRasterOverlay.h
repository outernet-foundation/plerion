...
class CesiumWebMapServiceRasterOverlay {
  ...
  public: explicit CesiumWebMapServiceRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumWebMapServiceRasterOverlay(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_layers)(void* thiz, void** reinteropException);
  public: ::DotNet::System::String layers() const;
  private: static void (*Property_set_layers)(void* thiz, void* value, void** reinteropException);
  public: void layers(const ::DotNet::System::String& value) const;
  ...
  public: bool operator==(const CesiumWebMapServiceRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumWebMapServiceRasterOverlayImpl& NativeImplementation() const noexcept;
};
