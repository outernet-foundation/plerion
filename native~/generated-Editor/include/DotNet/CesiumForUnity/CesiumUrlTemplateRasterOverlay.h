...
class CesiumUrlTemplateRasterOverlay {
  ...
  public: explicit CesiumUrlTemplateRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumUrlTemplateRasterOverlay(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_templateUrl)(void* thiz, void** reinteropException);
  public: ::DotNet::System::String templateUrl() const;
  private: static void (*Property_set_templateUrl)(void* thiz, void* value, void** reinteropException);
  public: void templateUrl(const ::DotNet::System::String& value) const;
  private: static ::std::uint32_t (*Property_get_projection)(void* thiz, void** reinteropException);
  public: ::DotNet::CesiumForUnity::CesiumUrlTemplateRasterOverlayProjection projection() const;
  private: static void (*Property_set_projection)(void* thiz, ::std::uint32_t value, void** reinteropException);
  public: void projection(::DotNet::CesiumForUnity::CesiumUrlTemplateRasterOverlayProjection value) const;
  ...
  private: static void* (*Property_get_requestHeaders)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::HeaderEntry> requestHeaders() const;
  private: static void (*Property_set_requestHeaders)(void* thiz, void* value, void** reinteropException);
  public: void requestHeaders(const ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::HeaderEntry>& value) const;
  ...
  public: bool operator==(const CesiumUrlTemplateRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumUrlTemplateRasterOverlayImpl& NativeImplementation() const noexcept;
};
