...
class CesiumTileMapServiceRasterOverlay {
  ...
  public: explicit CesiumTileMapServiceRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumTileMapServiceRasterOverlay(std::nullptr_t) noexcept;
  ...
  public: bool operator==(const CesiumTileMapServiceRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumTileMapServiceRasterOverlayImpl& NativeImplementation() const noexcept;
};
