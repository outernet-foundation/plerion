...
class CesiumFeatureIdTexture {
  ...
  public: explicit CesiumFeatureIdTexture(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumFeatureIdTexture(std::nullptr_t) noexcept;
  ...
  public: ::DotNet::CesiumForUnity::CesiumFeatureIdTextureStatus status() const;
  private: static void (*Property_set_status)(void* thiz, ::std::uint32_t value, void** reinteropException);
  public: void status(::DotNet::CesiumForUnity::CesiumFeatureIdTextureStatus value) const;
  ...
  public: ::CesiumForUnityNative::CesiumFeatureIdTextureImpl& NativeImplementation() const noexcept;
};
