...
class CesiumPrimitiveFeatures {
  ...
  public: explicit CesiumPrimitiveFeatures(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumPrimitiveFeatures(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_featureIdSets)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Array1<::DotNet::CesiumForUnity::CesiumFeatureIdSet> featureIdSets() const;
  private: static void (*Property_set_featureIdSets)(void* thiz, void* value, void** reinteropException);
  public: void featureIdSets(const ::DotNet::System::Array1<::DotNet::CesiumForUnity::CesiumFeatureIdSet>& value) const;
  ...
  public: bool operator==(const CesiumPrimitiveFeatures& rhs) const;
