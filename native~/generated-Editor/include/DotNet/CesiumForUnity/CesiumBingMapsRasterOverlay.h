...
class CesiumBingMapsRasterOverlay {
  ...
  public: explicit CesiumBingMapsRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumBingMapsRasterOverlay(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_bingMapsKey)(void* thiz, void** reinteropException);
  public: ::DotNet::System::String bingMapsKey() const;
  private: static void (*Property_set_bingMapsKey)(void* thiz, void* value, void** reinteropException);
  public: void bingMapsKey(const ::DotNet::System::String& value) const;
  private: static ::std::uint32_t (*Property_get_mapStyle)(void* thiz, void** reinteropException);
  public: ::DotNet::CesiumForUnity::BingMapsStyle mapStyle() const;
  private: static void (*Property_set_mapStyle)(void* thiz, ::std::uint32_t value, void** reinteropException);
  public: void mapStyle(::DotNet::CesiumForUnity::BingMapsStyle value) const;
  ...
  public: bool operator==(const CesiumBingMapsRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumBingMapsRasterOverlayImpl& NativeImplementation() const noexcept;
};
