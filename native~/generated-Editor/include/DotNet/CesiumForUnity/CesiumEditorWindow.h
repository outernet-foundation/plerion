...
class CesiumEditorWindow {
  ...
  public: explicit CesiumEditorWindow(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumEditorWindow(std::nullptr_t) noexcept;
  ...
  public: static ::DotNet::CesiumForUnity::CesiumEditorWindow currentWindow();
  public: static void currentWindow(const ::DotNet::CesiumForUnity::CesiumEditorWindow& value);
  ...
  public: bool operator==(const CesiumEditorWindow& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumEditorWindowImpl& NativeImplementation() const noexcept;
};
