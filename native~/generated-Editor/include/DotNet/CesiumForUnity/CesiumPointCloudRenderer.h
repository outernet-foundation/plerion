...
class CesiumPointCloudRenderer {
  ...
  public: explicit CesiumPointCloudRenderer(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumPointCloudRenderer(std::nullptr_t) noexcept;
  ...
  private: static void (*Property_set_tileInfo)(void* thiz, const ::DotNet::CesiumForUnity::Cesium3DTileInfo* value, void** reinteropException);
  public: void tileInfo(const ::DotNet::CesiumForUnity::Cesium3DTileInfo& value) const;
  ...
  public: bool operator==(const CesiumPointCloudRenderer& rhs) const;
