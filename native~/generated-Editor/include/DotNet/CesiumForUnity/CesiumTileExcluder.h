...
class CesiumTileExcluder {
  ...
  public: explicit CesiumTileExcluder(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumTileExcluder(std::nullptr_t) noexcept;
  ...
  private: static void (*CallAddToTileset_SrfNoP9IJM__ZwyysR9yJTQ)(void* thiz, void* tileset, void** reinteropException);
  public: void AddToTileset(const ::DotNet::CesiumForUnity::Cesium3DTileset& tileset) const;
  private: static void (*CallRemoveFromTileset_SrfNoP9IJM__ZwyysR9yJTQ)(void* thiz, void* tileset, void** reinteropException);
  public: void RemoveFromTileset(const ::DotNet::CesiumForUnity::Cesium3DTileset& tileset) const;
  private: static ::std::uint8_t (*CallShouldExclude_UETWPhv0ANQLUqKbOQlZcw)(void* thiz, void* tile, void** reinteropException);
  public: bool ShouldExclude(const ::DotNet::CesiumForUnity::Cesium3DTile& tile) const;
  ...
  public: bool operator==(const CesiumTileExcluder& rhs) const;
