...
class CesiumPolygonRasterOverlay {
  ...
  public: explicit CesiumPolygonRasterOverlay(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumPolygonRasterOverlay(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_polygons)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::CesiumCartographicPolygon> polygons() const;
  private: static void (*Property_set_polygons)(void* thiz, void* value, void** reinteropException);
  public: void polygons(const ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::CesiumCartographicPolygon>& value) const;
  private: static ::std::uint8_t (*Property_get_excludeSelectedTiles)(void* thiz, void** reinteropException);
  public: bool excludeSelectedTiles() const;
  private: static void (*Property_set_excludeSelectedTiles)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void excludeSelectedTiles(bool value) const;
  private: static ::std::uint8_t (*Property_get_invertSelection)(void* thiz, void** reinteropException);
  public: bool invertSelection() const;
  private: static void (*Property_set_invertSelection)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void invertSelection(bool value) const;
  ...
  public: bool operator==(const CesiumPolygonRasterOverlay& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumPolygonRasterOverlayImpl& NativeImplementation() const noexcept;
};
