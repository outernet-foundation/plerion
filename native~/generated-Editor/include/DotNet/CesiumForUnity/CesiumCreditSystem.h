...
class CesiumCreditSystem {
  ...
  public: explicit CesiumCreditSystem(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumCreditSystem(std::nullptr_t) noexcept;
  ...
  private: static void* (*Property_get_onScreenCredits)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::CesiumCredit> onScreenCredits() const;
  private: static void* (*Property_get_popupCredits)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::CesiumForUnity::CesiumCredit> popupCredits() const;
  private: static void* (*Property_get_images)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::UnityEngine::Texture2D> images() const;
  private: static void* (*CallGetDefaultCreditSystem_1B2M2Y8AsgTpgAmY7PhCfg)(void** reinteropException);
  public: static ::DotNet::CesiumForUnity::CesiumCreditSystem GetDefaultCreditSystem();
  private: static void* (*CallLoadImage_i4__FgVIR5VYHO4KBzPBwNQ)(void* thiz, void* url, void** reinteropException);
  public: ::DotNet::System::Collections::IEnumerator LoadImage(const ::DotNet::System::String& url) const;
  private: static ::std::int32_t (*CallGetNumberOfLoadingImages_1B2M2Y8AsgTpgAmY7PhCfg)(void* thiz, void** reinteropException);
  public: ::std::int32_t GetNumberOfLoadingImages() const;
  private: static void (*CallBroadcastCreditsUpdate_1B2M2Y8AsgTpgAmY7PhCfg)(void* thiz, void** reinteropException);
  public: void BroadcastCreditsUpdate() const;
  ...
  public: bool operator==(const CesiumCreditSystem& rhs) const;
  ...
  public: ::CesiumForUnityNative::CesiumCreditSystemImpl& NativeImplementation() const noexcept;
};
