...
class CesiumRuntimeSettings {
  ...
  public: explicit CesiumRuntimeSettings(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumRuntimeSettings(std::nullptr_t) noexcept;
  public: const ::DotNet::Reinterop::ObjectHandle& GetHandle() const;
  public: ::DotNet::Reinterop::ObjectHandle& GetHandle();
  public: operator ::DotNet::UnityEngine::Object() const;
  public: operator ::DotNet::System::Object() const;
  private: static ::std::int32_t (*Property_get_requestsPerCachePrune)(void** reinteropException);
  public: static ::std::int32_t requestsPerCachePrune();
  private: static ::std::uint64_t (*Property_get_maxItems)(void** reinteropException);
  public: static ::std::uint64_t maxItems();
  ...
  public: bool operator==(const CesiumRuntimeSettings& rhs) const;
