...
class CesiumCameraManager {
  ...
  public: explicit CesiumCameraManager(::DotNet::Reinterop::ObjectHandle&& handle) noexcept;
  public: CesiumCameraManager(std::nullptr_t) noexcept;
  ...
  private: static ::std::uint8_t (*Property_get_useSceneViewCameraInEditor)(void* thiz, void** reinteropException);
  public: bool useSceneViewCameraInEditor() const;
  private: static void (*Property_set_useSceneViewCameraInEditor)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void useSceneViewCameraInEditor(bool value) const;
  private: static ::std::uint8_t (*Property_get_useMainCamera)(void* thiz, void** reinteropException);
  public: bool useMainCamera() const;
  private: static void (*Property_set_useMainCamera)(void* thiz, ::std::uint8_t value, void** reinteropException);
  public: void useMainCamera(bool value) const;
  private: static void* (*Property_get_additionalCameras)(void* thiz, void** reinteropException);
  public: ::DotNet::System::Collections::Generic::List1<::DotNet::UnityEngine::Camera> additionalCameras() const;
  private: static void* (*CallGetOrCreate__t6GMXW_JRJi50mec2n__dA)(void* gameObject, void** reinteropException);
  public: static ::DotNet::CesiumForUnity::CesiumCameraManager GetOrCreate(const ::DotNet::UnityEngine::GameObject& gameObject);
  ...
  public: bool operator==(const CesiumCameraManager& rhs) const;
