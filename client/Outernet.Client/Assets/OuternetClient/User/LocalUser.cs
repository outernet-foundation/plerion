...
namespace Outernet.Client
{
    ...
    public class LocalUser : MonoBehaviour
    {
        ...
        public void Initialize(Guid id)
        {
            ...
            var ecefTransform =
                ReferenceFrame.UnityWorldToEcef(transform.position, transform.rotation);
        ...
        public static void ChangeSettingsMenuState(SettingsMenuState settingsMenuState)
        {
            ...
            var geoPose = ReferenceFrame.UnityWorldToEcef(settingsPanelPosition, settingsPanelRotation);
