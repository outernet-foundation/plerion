...
namespace Outernet.Client
{
    public class Anchor : MonoBehaviour
    {
        ...
        {
            var localTransform = LocalizedReferenceFrame.EcefToLocal(EcefPosition, EcefRotation);
        ...
        {
            (EcefPosition, EcefRotation) = LocalizedReferenceFrame.LocalToEcef(transform.position, transform.rotation);
        }
    }
}