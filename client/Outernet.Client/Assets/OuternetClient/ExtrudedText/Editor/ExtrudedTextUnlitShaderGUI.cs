...
{
	public class ExtrudedTextUnlitShaderGUI : TMP_BaseShaderGUI
	{
		static ShaderFeature s_outlineFeature;
		static ExtrudedTextShaderFeature s_volumeModeFeature;
		static ExtrudedTextShaderFeature s_raymarchModeFeature;
		static ExtrudedTextShaderFeature s_maxStepsFeature;
		...
		static ExtrudedTextUnlitShaderGUI()
		{
			...
			s_volumeModeFeature = new ExtrudedTextShaderFeature()
			{
			...
			s_raymarchModeFeature = new ExtrudedTextShaderFeature()
			{
			...
			s_maxStepsFeature = new ExtrudedTextShaderFeature()
			{
				undoLabel = "MaxSteps",
