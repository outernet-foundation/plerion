...
{
	internal static class ExtrudedTextData
	{
		public const string SHADER_NAME_SPACE = "ExtrudedText";
		public const string DEFAULT_SHADER_NAME = "ExtrudedText/Unlit";

		public static TMP_FontAsset DEFAULT_FONT_ASSET
		{
			get
			{
				return AssetDatabase.LoadAssetAtPath<TMP_FontAsset>("Packages/com.Outernet.Client/Runtime/Data/Fonts & Materials/LiberationSans SDF (3D).asset");
			}
		}
