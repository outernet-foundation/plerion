...
{
    public interface IObservablePrimitiveMap : IObservableNode, IEnumerable
    {
        Type leftType { get; }
        Type rightType { get; }
    ...
    public class ObservablePrimitiveMap<TLeft, TRight> :
        ObservableNode,
        IObservablePrimitiveMap,
        IEnumerable<PrimitiveMapPair<TLeft, TRight>>,
        ObserveThing.ICollectionObservable<PrimitiveMapPair<TLeft, TRight>>
    {
