...
class Camera:
    ...
    def close(self) -> None: ...
    def get_camera_information(self, resizer: None | object = ...) -> CameraInformation: ...
    def enable_positional_tracking(self, py_tracking: PositionalTrackingParameters | None = ...) -> ERROR_CODE: ...
    def disable_positional_tracking(self) -> None: ...
    def grab(self, py_runtime: RuntimeParameters | None = ...) -> ERROR_CODE: ...
    def get_position(self, py_pose: Pose, reference_frame: REFERENCE_FRAME = ...) -> object: ...
    def retrieve_image(
        self, py_mat: Mat, view: VIEW = ..., mem_type: MEM = ..., resolution: object | None = ...
    ) -> ERROR_CODE: ...
    def set_camera_settings(self, setting: VIDEO_SETTINGS, value: float | int) -> ERROR_CODE: ...
