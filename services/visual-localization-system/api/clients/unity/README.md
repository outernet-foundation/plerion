# Plerion - the C# library for the Plerion
...
*DefaultApi* | [**GetUploadCaptureSessionTarPresignedUrl**](docs/DefaultApi.md#getuploadcapturesessiontarpresignedurl) | **PUT** /capture_sessions/{id}/tar | Get Upload Capture Session Tar Presigned Url
...
## Documentation for Models
 ...
 - [Model.FullOpenCVCamera](docs/FullOpenCVCamera.md)
 ...
 - [Model.Intrinsics](docs/Intrinsics.md)
 ...
 - [Model.OpenCVCamera](docs/OpenCVCamera.md)
 - [Model.OrchestrationStatus](docs/OrchestrationStatus.md)
 - [Model.PinholeCamera](docs/PinholeCamera.md)
 ...
 - [Model.RigCamera](docs/RigCamera.md)
 - [Model.RigConfig](docs/RigConfig.md)
 - [Model.RigInput](docs/RigInput.md)
 - [Model.RigOutput](docs/RigOutput.md)
