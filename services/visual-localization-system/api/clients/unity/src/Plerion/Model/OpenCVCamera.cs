...
namespace Plerion.Model
{
    ...
    /// OpenCVCamera
    /// </summary>
    [DataContract(Name = "OpenCVCamera")]
    public partial class OpenCVCamera
    {
        /// <summary>
        /// Defines Mirroring
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenCVCamera" /> class.
        /// </summary>
        ...
        public OpenCVCamera(int width, int height, MirroringEnum mirroring, RotationEnum rotation, ModelEnum model, double fx, double fy, double cx, double cy, double k1, double k2, double p1, double p2, double k3)
        {
            this.Width = width;
            this.Height = height;
