...
namespace Plerion.Model
{
    ...
    /// PinholeCamera
    /// </summary>
    [DataContract(Name = "PinholeCamera")]
    public partial class PinholeCamera
    {
        /// <summary>
        /// Defines Mirroring
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PinholeCamera" /> class.
        /// </summary>
        ...
        public PinholeCamera(int width, int height, MirroringEnum mirroring, RotationEnum rotation, ModelEnum model, double fx, double fy, double cx, double cy)
        {
            this.Width = width;
            this.Height = height;
