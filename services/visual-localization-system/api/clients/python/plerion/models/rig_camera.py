...
class RigCamera(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "ref_sensor", "rotation", "translation", "intrinsics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RigCamera from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of intrinsics
        if self.intrinsics:
            _dict['intrinsics'] = self.intrinsics.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RigCamera from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "intrinsics": Intrinsics.from_dict(obj["intrinsics"]) if obj.get("intrinsics") is not None else None
        })
