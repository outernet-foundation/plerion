...
import plerion
from plerion.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = plerion.Configuration(
    host = "http://localhost"
)
...
async with plerion.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = plerion.DefaultApi(api_client)
    capture_session_create = plerion.CaptureSessionCreate() # CaptureSessionCreate | 
...
*DefaultApi* | [**get_upload_capture_session_tar_presigned_url**](docs/DefaultApi.md#get_upload_capture_session_tar_presigned_url) | **PUT** /capture_sessions/{id}/tar | Get Upload Capture Session Tar Presigned Url
...
## Documentation For Models
 ...
 - [MapLocalizationInput](docs/MapLocalizationInput.md)
 - [MapLocalizationOutput](docs/MapLocalizationOutput.md)
 ...
 - [RigCamera](docs/RigCamera.md)
 - [RigConfig](docs/RigConfig.md)
 - [RigInput](docs/RigInput.md)
 - [RigOutput](docs/RigOutput.md)
