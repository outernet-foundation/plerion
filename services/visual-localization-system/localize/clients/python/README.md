...
import plerion_localize
from plerion_localize.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = plerion_localize.Configuration(
    host = "http://localhost"
)
...
async with plerion_localize.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = plerion_localize.DefaultApi(api_client)
    id = 'id_example' # str | 
...
## Documentation For Models
 ...
 - [LocalizationInput](docs/LocalizationInput.md)
 - [LocalizationMetrics](docs/LocalizationMetrics.md)
 - [LocalizationOutput](docs/LocalizationOutput.md)
