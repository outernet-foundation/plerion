...
from plerion import ApiClient, Configuration
from plerion.api.default_api import DefaultApi
...
async def main_async() -> None:
    ...
    async with ApiClient(Configuration(host=API_BASE_URL)) as api_client:
        ...
        localizations: list[MapLocalizationOutput] = await api.localize_image(
            session_id, (TEST_IMAGE_PATH.name, image_bytes)
        )
        ...
        # MapLocalizationOutput looks like { id: <map_id>, transform: <Transform> }
