...
namespace PlerionClient.Model
{
    ...
    /// BodyUpsertLayers
    /// </summary>
    [DataContract(Name = "Body_upsert_layers")]
    public partial class BodyUpsertLayers
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BodyUpsertLayers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BodyUpsertLayers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BodyUpsertLayers" /> class.
        /// </summary>
        /// <param name="layers">layers (required).</param>
        public BodyUpsertLayers(List<LayerModel> layers = default)
        {
            // to ensure "layers" is required (not null)
            if (layers == null)
            {
                throw new ArgumentNullException("layers is a required property for BodyUpsertLayers and cannot be null");
            }
            this.Layers = layers;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BodyUpsertLayers {\n");
