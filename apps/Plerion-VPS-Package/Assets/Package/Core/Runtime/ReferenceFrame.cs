...
namespace Plerion.VPS
{
    public static class ReferenceFrame
    {
        ...
        public static void SetUnityWorldToEcefTransform(double4x4 unityWorldToEcefTransform)
        {
            ...
            var currentPosition = ReferenceFrame.unityWorldToEcefTransform.Position();
            var currentRotation = ReferenceFrame.unityWorldToEcefTransform.Rotation();
            ...
            ReferenceFrame.unityWorldToEcefTransform = unityWorldToEcefTransform;
        ...
        public static async UniTask LocalizeFromCameraImage(CameraImage cameraImage, Vector3 cameraPosition, Quaternion cameraRotation)
        {
            ...
            var localizeResult = await VPSManager.API.LocalizeAsync(new PlerionClient.Model.LocalizationRequest(
                ...
                cameraRotation.ToList(),
                cameraImage.cameraOrientation.ToList(),
                default // cameraImage.pixelBuffer
            ));
            ...
            {
                mapEcefPosition = localizeResult.MapEcefPosition.ToDouble3(),
                mapEcefRotation = localizeResult.MapEcefRotation.ToQuaternion(),
                originalCameraWorldPosition = cameraPosition,
                originalCameraWorldRotation = cameraRotation,
                estimatedCameraPosition = localizeResult.EstimatedCameraPosition.ToVector3(),
                estimatedCameraRotation = localizeResult.EstimatedCameraRotation.ToQuaternion(),
