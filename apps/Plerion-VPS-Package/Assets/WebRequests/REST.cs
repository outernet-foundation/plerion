...
namespace Plerion
{
    public static class RestClient
    {
            ...
            UniTaskCompletionSource taskCompletionSource)
        {
            ...
            {
                Log.Error(LogGroup.Rest, $"Unexpected exception in RestClient.ExecuteRequest for url: {url}", exception);
        ...
        private static async UniTask<UnityWebRequest> SendRequestWithRetries(Func<UnityWebRequest> requestFactory)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    Log.Error(LogGroup.Rest, $"Retrying request ({retries}/{MaxRetries}): {webRequest.url}", exception);
