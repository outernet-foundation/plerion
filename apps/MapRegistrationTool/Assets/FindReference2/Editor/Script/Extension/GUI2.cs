...
namespace vietlabs.fr2
{
    ...
    {
        // Redirect to new FR2_Scope system for consistency
        public static FR2_Scope.GUIColorScope Color(Color c) => FR2_Scope.GUIColor(c);
        public static FR2_Scope.GUIContentColorScope ContentColor(Color c) => FR2_Scope.ContentColor(c);
        public static FR2_Scope.GUIBackgroundColorScope BackgroundColor(Color c) => FR2_Scope.BGColor(c);
        public static FR2_Scope.GUIEnabledScope Enabled(bool enabled) => FR2_Scope.GUIEnable(enabled);
        
        public static void DrawToggleLeft(string label, ref bool value)
        {
    ...
    internal static class GUI2
    {
        ...
        public static void ContentColor(Action a, Color c, float? alpha = null)
        {
            ...
            using (FR2_Scope.ContentColor(c))
            {
                a();
            }
        }
        ...
        internal static bool ToolbarToggle(Rect r, ref bool value, Texture icon, Vector2 padding, string tooltip = null)
        {
            ...
            if (icon != null)
            {
                ...
                using (GUIColor(value ? FR2_Theme.Current.IconActiveColor : FR2_Theme.Current.IconColor))
                {
        ...
        {
            // Apply theme-appropriate icon color
            using (FR2_Scope.ContentColor(value ? FR2_Theme.Current.IconActiveColor : FR2_Theme.Current.IconColor))
            {
        ...
        {
            var vv = false;
            using (ProfileMethod("FR2-GUI2.ToolbarToggle"))
            {
        ...
        internal static bool ToolbarToggle(ref bool value, Texture icon, Vector2 padding, string tooltip, Rect position, bool hasContent = false)
        {
            ...
            Color? bgColor = (!value && hasContent) ? UnityEngine.Color.yellow : null;
            Color contentColor = value ? FR2_Theme.Current.IconActiveColor : FR2_Theme.Current.IconColor;
