...
namespace PlerionApiClient.Model
{
    ...
    public partial class FullOpenCVCameraConfig
    {
        ...
        public FullOpenCVCameraConfig(int width, int height, OrientationEnum orientation, ModelEnum model, double fx, double fy, double cx, double cy, double k1, double k2, double p1, double p2, double k3, double k4, double k5, double k6)
        {
            this.Width = width;
            this.Height = height;
