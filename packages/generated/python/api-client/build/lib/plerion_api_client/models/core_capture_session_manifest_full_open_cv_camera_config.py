...
class CoreCaptureSessionManifestFullOpenCVCameraConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["width", "height", "mirroring", "rotation", "model", "fx", "fy", "cx", "cy", "k1", "k2", "p1", "p2", "k3", "k4", "k5", "k6"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreCaptureSessionManifestFullOpenCVCameraConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreCaptureSessionManifestFullOpenCVCameraConfig from a dict"""
        if obj is None:
            return None
